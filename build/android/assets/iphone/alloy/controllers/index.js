...
function Controller() {
    ...
    startCompass ? $.__views.index.addEventListener("click", startCompass) : __defers["$.__views.index!click!startCompass"] = true;
    ...
    if (Ti.Geolocation.locationServicesEnabled) {
        ...
        Titanium.Geolocation.addEventListener("location", function(e) {
            ...
            if (longitudeString) {
                ...
                $.distance.text = 15 > distanceMeters ? "Je bent bij de hotspot!" : distanceMeters + " meter";
                Ti.API.info(distanceMeters);
            }
        });
    } else alert("Schakel locatievoorzieningen in");
    $.index.open();
    __defers["$.__views.index!click!startCompass"] && $.__views.index.addEventListener("click", startCompass);
    _.extend($, exports);
}

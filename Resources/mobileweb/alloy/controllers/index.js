    ...
    if (Ti.Geolocation.locationServicesEnabled) {
        ...
        Titanium.Geolocation.addEventListener("location", function(e) {
            ...
            if (longitudeString) {
                ...
                .4 > bgColor ? $.index.backgroundColor = "#c0392b" : bgColor >= .4 && .6 > bgColor ? $.index.backgroundColor = "#c74c3c" : bgColor >= .6 && 1 > bgColor ? $.index.backgroundColor = "#e67e22" : bgColor >= 1 && 2 > bgColor ? $.index.backgroundColor = "#f39c12" : bgColor >= 2 && 3 > bgColor ? $.index.backgroundColor = "#2ecc71" : bgColor > 3 && ($.index.backgroundColor = "#87d37c");
                $.distance.text = 15 > distanceMeters ? "Je bent bij de hotspot!" : distanceMeters + "m";
